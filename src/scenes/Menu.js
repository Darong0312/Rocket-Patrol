class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(game.config.width/2, game.config.height/2, 'P1: Use Key A D to move & W to fire', menuTextConfig).setOrigin(0.5);
        this.add.text(game.config.width/2, game.config.height/2 + borderUISize + borderPadding, 'P2: Use ←→ arrows to move & (↑) to fire', menuTextConfig).setOrigin(0.5);
